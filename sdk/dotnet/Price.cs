...
///         Product = stripe_product.Product.Id,
///         Currency = "aud",
///         CustomUnitAmount = new Stripe.Inputs.PriceCustomUnitAmountArgs
///         {
///             Enabled = true,
///             Minimum = 500,
///             Maximum = 50000,
...
///     var priceStripeIndex_pricePrice2 = new Stripe.Price("priceStripeIndex/pricePrice2", new()
///     {
///         Product = stripe_product.Product.Id,
///         Currency = "aud",
...
public sealed class PriceArgs : global::Pulumi.ResourceArgs
{
    ...
    public static new PriceArgs Empty => new();
}
...
public sealed class PriceState : global::Pulumi.ResourceArgs
{
    ...
    public static new PriceState Empty => new();
}
