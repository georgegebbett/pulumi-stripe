...
class PriceArgs:
    def __init__(__self__, *,
                 ...
                 billing_scheme: Optional[pulumi.Input[_builtins.str]] = None,
                 currency_options: Optional[pulumi.Input[Sequence[pulumi.Input['PriceCurrencyOptionArgs']]]] = None,
                 custom_unit_amount: Optional[pulumi.Input['PriceCustomUnitAmountArgs']] = None,
                 ...
                 tiers_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 transfer_lookup_key: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] product: String. The ID of the product that this price will belong to.
        :param pulumi.Input[_builtins.bool] active: Bool. Whether the price can be used for new purchases. Defaults to `true`.
        :param pulumi.Input[_builtins.str] billing_scheme: String. Describes how to compute the price per period. Either `per_unit` or `tiered`
        ...
        :param pulumi.Input['PriceCustomUnitAmountArgs'] custom_unit_amount: List(Resource). When set, provides configuration for the amount to be adjusted by
               the customer during Checkout Sessions and Payment Links.
               For individual fields see Custom Unit Amount.
        :param pulumi.Input[_builtins.str] lookup_key: String. A lookup key used to retrieve prices dynamically from a static string.
        ...
        :param pulumi.Input[_builtins.str] nickname: String. A brief description of the price, hidden from customers.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PriceTierArgs']]] tiers: List(Resource). Each element represents a pricing tier. This parameter requires `billing_scheme`
               ...
               see Tiers.
        :param pulumi.Input[_builtins.str] tiers_mode: String. Defines if the tiering price should be `graduated`
        ...
        :param pulumi.Input[_builtins.bool] transfer_lookup_key: Bool. If set to `true`, will atomically remove the lookup key from the existing
        ...
        :param pulumi.Input[_builtins.int] unit_amount: Int. A positive integer in cents (or `-1` for a free
    ...
    def billing_scheme(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def billing_scheme(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def custom_unit_amount(self) -> Optional[pulumi.Input['PriceCustomUnitAmountArgs']]:
        """
    ...
    def custom_unit_amount(self, value: Optional[pulumi.Input['PriceCustomUnitAmountArgs']]):
    ...
    def tiers_mode(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @tiers_mode.setter
    def tiers_mode(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "tiers_mode", value)

    @_builtins.property
    @pulumi.getter(name="transferLookupKey")
    def transfer_lookup_key(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def transfer_lookup_key(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class _PriceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['PriceTransformQuantityArgs'] transform_quantity: List(Resource). Apply a transformation to the reported usage or set quantity before
               computing the billed price. Cannot be combined with `tiers`. For details of individual arguments
               see Transform Quantity.
        :param pulumi.Input[_builtins.str] type: String. One of `one_time` or `recurring` depending on whether the price is for a one-time purchase or a
...
class Price(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 custom_unit_amount: Optional[pulumi.Input[Union['PriceCustomUnitAmountArgs', 'PriceCustomUnitAmountArgsDict']]] = None,
                 lookup_key: Optional[pulumi.Input[_builtins.str]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 nickname: Optional[pulumi.Input[_builtins.str]] = None,
                 product: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        price_stripe_index_price_price2 = stripe.Price("priceStripeIndex/pricePrice2",
            product=stripe_product["product"]["id"],
            currency="aud",
        ...
        :param pulumi.Input[_builtins.str] billing_scheme: String. Describes how to compute the price per period. Either `per_unit` or `tiered`
               ...
               defined using the `tiers` and `tiers_mode` attributes.
        :param pulumi.Input[_builtins.str] currency: String. Three-letter ISO currency code, in lowercase - [supported currencies](https://stripe.com/docs/currencies).
        :param pulumi.Input[Sequence[pulumi.Input[Union['PriceCurrencyOptionArgs', 'PriceCurrencyOptionArgsDict']]]] currency_options: List(Resource). Prices defined in each available currency option. For details
               of individual arguments see Currency Options.
        :param pulumi.Input[Union['PriceCustomUnitAmountArgs', 'PriceCustomUnitAmountArgsDict']] custom_unit_amount: List(Resource). When set, provides configuration for the amount to be adjusted by
               the customer during Checkout Sessions and Payment Links.
               For individual fields see Custom Unit Amount.
        :param pulumi.Input[_builtins.str] lookup_key: String. A lookup key used to retrieve prices dynamically from a static string.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] metadata: Map(String). Set of key-value pairs that you can attach to an object. This can be useful for
        ...
        :param pulumi.Input[_builtins.str] nickname: String. A brief description of the price, hidden from customers.
        :param pulumi.Input[_builtins.str] product: String. The ID of the product that this price will belong to.
        :param pulumi.Input[Union['PriceRecurringArgs', 'PriceRecurringArgsDict']] recurring: List(Resource). The recurring components of a price such as `interval` and `usage_type`. For
               details of individual arguments see Recurring.
        :param pulumi.Input[_builtins.str] tax_behavior: String. Specifies whether the price is considered inclusive of taxes or exclusive of
               taxes. One of `inclusive`, `exclusive`, or `unspecified`. Once specified as either `inclusive` or `exclusive`, it
               cannot be changed, default is `unspecified`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PriceTierArgs', 'PriceTierArgsDict']]]] tiers: List(Resource). Each element represents a pricing tier. This parameter requires `billing_scheme`
               to be set to `tiered`. See also the documentation for `billing_scheme`. For details of individual arguments
               see Tiers.
        :param pulumi.Input[_builtins.str] tiers_mode: String. Defines if the tiering price should be `graduated`
               or `volume` based. In `volume`-based tiering, the maximum quantity within a period determines the per-unit price,
        ...
        :param pulumi.Input[_builtins.bool] transfer_lookup_key: Bool. If set to `true`, will atomically remove the lookup key from the existing
               price, and assign it to this price.
        :param pulumi.Input[Union['PriceTransformQuantityArgs', 'PriceTransformQuantityArgsDict']] transform_quantity: List(Resource). Apply a transformation to the reported usage or set quantity before
               computing the billed price. Cannot be combined with `tiers`. For details of individual arguments
               see Transform Quantity.
        :param pulumi.Input[_builtins.int] unit_amount: Int. A positive integer in cents (or `-1` for a free
               price) representing how much to charge.
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[_builtins.str]] = None,
            unit_amount: Optional[pulumi.Input[_builtins.int]] = None,
            unit_amount_decimal: Optional[pulumi.Input[_builtins.float]] = None) -> 'Price':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="lookupKey")
    def lookup_key(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        String. A lookup key used to retrieve prices dynamically from a static string.
        """
        return pulumi.get(self, "lookup_key")
    ...
    @_builtins.property
    @pulumi.getter(name="tiersMode")
    def tiers_mode(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        String. Defines if the tiering price should be `graduated`
        or `volume` based. In `volume`-based tiering, the maximum quantity within a period determines the per-unit price,
        in `graduated` tiering pricing can successively change as the quantity grows.
    ...
    @_builtins.property
    @pulumi.getter(name="unitAmount")
    def unit_amount(self) -> pulumi.Output[_builtins.int]:
        """
        Int. A positive integer in cents (or `-1` for a free
        price) representing how much to charge.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="unitAmountDecimal")
    def unit_amount_decimal(self) -> pulumi.Output[_builtins.float]:
        """
        Float. Same as `unit_amount`, but accepts a decimal value in cents with at most 12
        decimal places. Only one of `unit_amount` and `unit_amount_decimal` can be set.
        """
