...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `stripe` with the `NAME` of your provider.
...
- binary: pulumi-resource-stripe
  ...
  ignore: []
  ldflags:
  - -X github.com/georgegebbett/pulumi-stripe/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-stripe/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-stripe_darwin_amd64_v1
│   └── pulumi-resource-stripe
├── pulumi-stripe_darwin_arm64
│   └── pulumi-resource-stripe
├── pulumi-stripe_linux_amd64_v1
│   └── pulumi-resource-stripe
├── pulumi-stripe_linux_arm64
│   └── pulumi-resource-stripe
├── pulumi-stripe_windows_amd64_v1
│   └── pulumi-resource-stripe.exe
└── pulumi-stripe_windows_arm64
    └── pulumi-resource-stripe.exe
```
