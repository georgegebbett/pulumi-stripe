...
class CardArgs:
    def __init__(__self__, *,
                 ...
                 exp_month: pulumi.Input[_builtins.int],
                 exp_year: pulumi.Input[_builtins.int],
                 number: pulumi.Input[_builtins.str],
                 address: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 cvc: Optional[pulumi.Input[_builtins.int]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None):
        """
        The set of arguments for constructing a Card resource.
        :param pulumi.Input[_builtins.str] customer: String. The customer that this card belongs to.
        :param pulumi.Input[_builtins.int] exp_month: Int. Number representing the card's expiration month.
        :param pulumi.Input[_builtins.int] exp_year: Int. Four-digit number representing the card's expiration year.
        :param pulumi.Input[_builtins.str] number: String. The card number, as a string without any separators.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] address: Map(String). Address map with fields related to the address: `line1`, `line2`, `city`, `state`
               , `zip` and `country`.
        :param pulumi.Input[_builtins.int] cvc: Int. Card security code. Highly recommended to always include this value, but it's required only
        ...
        :param pulumi.Input[_builtins.str] name: String. Cardholder name.
        """
    ...
    def exp_month(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @exp_month.setter
    def exp_month(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "exp_month", value)

    @_builtins.property
    @pulumi.getter(name="expYear")
    def exp_year(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @exp_year.setter
    def exp_year(self, value: pulumi.Input[_builtins.int]):
    ...
    @_builtins.property
    @pulumi.getter
    def cvc(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    @cvc.setter
    def cvc(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class _CardState:
    def __init__(__self__, *,
                 address: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 address_line1_check: Optional[pulumi.Input[_builtins.str]] = None,
                 address_zip_check: Optional[pulumi.Input[_builtins.str]] = None,
                 available_payout_methods: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 brand: Optional[pulumi.Input[_builtins.str]] = None,
                 country: Optional[pulumi.Input[_builtins.str]] = None,
                 customer: Optional[pulumi.Input[_builtins.str]] = None,
                 cvc: Optional[pulumi.Input[_builtins.int]] = None,
                 cvc_check: Optional[pulumi.Input[_builtins.str]] = None,
                 exp_month: Optional[pulumi.Input[_builtins.int]] = None,
                 exp_year: Optional[pulumi.Input[_builtins.int]] = None,
                 fingerprint: Optional[pulumi.Input[_builtins.str]] = None,
                 funding: Optional[pulumi.Input[_builtins.str]] = None,
                 last4: Optional[pulumi.Input[_builtins.str]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 number: Optional[pulumi.Input[_builtins.str]] = None,
                 tokenization_method: Optional[pulumi.Input[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering Card resources.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] address: Map(String). Address map with fields related to the address: `line1`, `line2`, `city`, `state`
               , `zip` and `country`.
        :param pulumi.Input[_builtins.str] address_line1_check: String. If address `line1` was provided, results of the check: `pass`, `fail`, `unavailable`,
               or `unchecked`.
        :param pulumi.Input[_builtins.str] address_zip_check: String. If address `zip` was provided, results of the check: `pass`, `fail`, `unavailable`,
               or `unchecked`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] available_payout_methods: List(String). A set of available payout methods for this card. Only values from this set
               should be passed as the method when creating a payout.
        :param pulumi.Input[_builtins.str] brand: String. Card brand. Can be `American Express`, `Diners Club`, `Discover`, `JCB`, `MasterCard`, `UnionPay`
               , `Visa`, or `Unknown`.
        :param pulumi.Input[_builtins.str] country: String. Two-letter ISO code representing the country of the card. You could use this attribute to get a
               sense of the international breakdown of cards you’ve collected.
        :param pulumi.Input[_builtins.str] customer: String. The customer that this card belongs to.
        :param pulumi.Input[_builtins.int] cvc: Int. Card security code. Highly recommended to always include this value, but it's required only
               for accounts based in European countries.
        :param pulumi.Input[_builtins.str] cvc_check: String. If a `cvc` was provided, results of the check: `pass`, `fail`, `unavailable`, or `unchecked`. A
               result of `unchecked` indicates that CVC was provided but hasn’t been checked yet
        :param pulumi.Input[_builtins.int] exp_month: Int. Number representing the card's expiration month.
        :param pulumi.Input[_builtins.int] exp_year: Int. Four-digit number representing the card's expiration year.
        :param pulumi.Input[_builtins.str] fingerprint: String. Uniquely identifies this particular card number. You can use this attribute to check whether
               ...
               number.
        :param pulumi.Input[_builtins.str] funding: String. Card funding type. Can be `credit`, `debit`, `prepaid`, or `unknown`.
        :param pulumi.Input[_builtins.str] last4: String. The last four digits of the card.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] metadata: Map(String). Set of key-value pairs that you can attach to an object. This can be useful for
               storing additional information about the object in a structured format.
        :param pulumi.Input[_builtins.str] name: String. Cardholder name.
        :param pulumi.Input[_builtins.str] number: String. The card number, as a string without any separators.
        :param pulumi.Input[_builtins.str] tokenization_method: String. If the card number is tokenized, this is the method that was used. Can
    ...
    def address_line1_check(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def address_line1_check(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "address_line1_check", value)

    @_builtins.property
    @pulumi.getter(name="addressZipCheck")
    def address_zip_check(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def address_zip_check(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "address_zip_check", value)

    @_builtins.property
    @pulumi.getter(name="availablePayoutMethods")
    def available_payout_methods(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def available_payout_methods(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def cvc_check(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @cvc_check.setter
    def cvc_check(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "cvc_check", value)

    @_builtins.property
    @pulumi.getter(name="expMonth")
    def exp_month(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        Int. Number representing the card's expiration month.
        """
        return pulumi.get(self, "exp_month")
    ...
    @exp_month.setter
    def exp_month(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "exp_month", value)

    @_builtins.property
    @pulumi.getter(name="expYear")
    def exp_year(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        Int. Four-digit number representing the card's expiration year.
        """
        return pulumi.get(self, "exp_year")
    ...
    @exp_year.setter
    def exp_year(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "exp_year", value)
    ...
    @_builtins.property
    @pulumi.getter
    def funding(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @funding.setter
    def funding(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "funding", value)

    @_builtins.property
    @pulumi.getter
    def last4(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @last4.setter
    def last4(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def tokenization_method(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def tokenization_method(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class Card(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        > Using the Card resource may potentially leak credit card information into your Terraform State.
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            number: Optional[pulumi.Input[_builtins.str]] = None,
            tokenization_method: Optional[pulumi.Input[_builtins.str]] = None) -> 'Card':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="addressLine1Check")
    def address_line1_check(self) -> pulumi.Output[_builtins.str]:
        """
        String. If address `line1` was provided, results of the check: `pass`, `fail`, `unavailable`,
        or `unchecked`.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="addressZipCheck")
    def address_zip_check(self) -> pulumi.Output[_builtins.str]:
        """
        String. If address `zip` was provided, results of the check: `pass`, `fail`, `unavailable`,
        or `unchecked`.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="availablePayoutMethods")
    def available_payout_methods(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        List(String). A set of available payout methods for this card. Only values from this set
        should be passed as the method when creating a payout.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def cvc(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Int. Card security code. Highly recommended to always include this value, but it's required only
        for accounts based in European countries.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="cvcCheck")
    def cvc_check(self) -> pulumi.Output[_builtins.str]:
        """
        String. If a `cvc` was provided, results of the check: `pass`, `fail`, `unavailable`, or `unchecked`. A
        result of `unchecked` indicates that CVC was provided but hasn’t been checked yet
        """
    ...
    @_builtins.property
    @pulumi.getter(name="expMonth")
    def exp_month(self) -> pulumi.Output[_builtins.int]:
        """
        Int. Number representing the card's expiration month.
        """
        return pulumi.get(self, "exp_month")
    ...
    @_builtins.property
    @pulumi.getter(name="expYear")
    def exp_year(self) -> pulumi.Output[_builtins.int]:
        """
        Int. Four-digit number representing the card's expiration year.
        """
        return pulumi.get(self, "exp_year")
    ...
    @_builtins.property
    @pulumi.getter
    def funding(self) -> pulumi.Output[_builtins.str]:
        """
        String. Card funding type. Can be `credit`, `debit`, `prepaid`, or `unknown`.
        """
        return pulumi.get(self, "funding")
    ...
    @_builtins.property
    @pulumi.getter(name="tokenizationMethod")
    def tokenization_method(self) -> pulumi.Output[_builtins.str]:
        """
        String. If the card number is tokenized, this is the method that was used. Can
        be `android_pay` (includes Google Pay), `apple_pay`, `masterpass`, `visa_checkout`, or `null`.
        """
