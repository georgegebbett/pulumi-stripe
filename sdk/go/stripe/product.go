...
type Product struct {
	...
	MarketingFeatures pulumi.StringArrayOutput `pulumi:"marketingFeatures"`
...
type productState struct {
	...
	// List(String). A list of up to 15 marketing features for this product. These are displayed in pricing tables.
	MarketingFeatures []string `pulumi:"marketingFeatures"`
	// Map(String). Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
...
type ProductState struct {
	...
	// List(String). A list of up to 15 marketing features for this product. These are displayed in pricing tables.
	MarketingFeatures pulumi.StringArrayInput
	// Map(String). Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
...
// List(String). A list of up to 15 marketing features for this product. These are displayed in pricing tables.
func (o ProductOutput) MarketingFeatures() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Product) pulumi.StringArrayOutput { return v.MarketingFeatures }).(pulumi.StringArrayOutput)
}
