...
//				Product:  pulumi.Any(stripe_product.Product.Id),
//				Currency: pulumi.String("aud"),
//				CustomUnitAmount: &stripe.PriceCustomUnitAmountArgs{
//					Enabled: pulumi.Bool(true),
//					Minimum: pulumi.Int(500),
//					Maximum: pulumi.Int(50000),
//					Preset:  pulumi.Int(1000),
//				},
//			})
//			if err != nil {
//				return err
...
//			_, err = stripe.NewPrice(ctx, "priceStripeIndex/pricePrice2", &stripe.PriceArgs{
//				Product:       pulumi.Any(stripe_product.Product.Id),
//				Currency:      pulumi.String("aud"),
...
//					Meter:          pulumi.String("mtr_1234567890"),
//				},
//			})
//			if err != nil {
//				return err
...
type Price struct {
	...
	CustomUnitAmount PriceCustomUnitAmountPtrOutput `pulumi:"customUnitAmount"`
...
type priceState struct {
	...
	// the customer during Checkout Sessions and Payment Links.
	// For individual fields see Custom Unit Amount.
	CustomUnitAmount *PriceCustomUnitAmount `pulumi:"customUnitAmount"`
	// String. A lookup key used to retrieve prices dynamically from a static string.
...
type PriceState struct {
	...
	// the customer during Checkout Sessions and Payment Links.
	// For individual fields see Custom Unit Amount.
	CustomUnitAmount PriceCustomUnitAmountPtrInput
	// String. A lookup key used to retrieve prices dynamically from a static string.
...
// the customer during Checkout Sessions and Payment Links.
// For individual fields see Custom Unit Amount.
func (o PriceOutput) CustomUnitAmount() PriceCustomUnitAmountPtrOutput {
	return o.ApplyT(func(v *Price) PriceCustomUnitAmountPtrOutput { return v.CustomUnitAmount }).(PriceCustomUnitAmountPtrOutput)
}
...
// taxes. One of `inclusive`, `exclusive`, or `unspecified`. Once specified as either `inclusive` or `exclusive`, it
// cannot be changed, default is `unspecified`.
func (o PriceOutput) TaxBehavior() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Price) pulumi.StringPtrOutput { return v.TaxBehavior }).(pulumi.StringPtrOutput)
}
