...
export class Price extends pulumi.CustomResource {
     ...
     */
    public readonly billingScheme!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly unitAmount!: pulumi.Output<number | undefined>;
    /**
     ...
     */
    public readonly unitAmountDecimal!: pulumi.Output<number | undefined>;
