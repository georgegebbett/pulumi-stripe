...
static class Utilities
{
    ...
    static readonly string[] trueValues = ["1", "t", "T", "true", "TRUE", "True"];
    static readonly string[] falseValues = ["0", "f", "F", "false", "FALSE", "False"];
    ...
    public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
    {
        ...
        dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/georgegebbett";
        return dst;
    }
...
internal sealed class StripeResourceTypeAttribute(string type) : global::Pulumi.ResourceTypeAttribute(type, Utilities.Version)
{
}
